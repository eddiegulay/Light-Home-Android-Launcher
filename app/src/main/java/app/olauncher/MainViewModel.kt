...
import app.lightHome.helper.SingleLiveEvent
import app.lightHome.helper.WallpaperWorker
import app.lightHome.helper.getAppsList
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val isLightHomeDefault = MutableLiveData<Boolean>()
    ...
    fun isLightHomeDefault() {
        isLightHomeDefault.value = isLightHomeDefault(appContext)
    }
