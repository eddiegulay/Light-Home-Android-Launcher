...
//    const val THEME_MODE_SYSTEM = 2
    ...
    const val URL_ABOUT_OLAUNCHER = "https://tanujnotes.substack.com/p/lightHome-minimal-af-launcher?utm_source=lightHome"
    const val URL_OLAUNCHER_PRIVACY = "https://tanujnotes.notion.site/Light Home-Privacy-Policy-dd6ac5101ddd4b3da9d27057889d44ab"
    const val URL_DOUBLE_TAP = "https://tanujnotes.notion.site/Double-tap-to-lock-Light Home-0f7fb103ec1f47d7a90cdfdcd7fb86ef"
    const val URL_OLAUNCHER_GITHUB = "https://www.github.com/tanujnotes/Light Home"
    const val URL_OLAUNCHER_PLAY_STORE = "https://play.google.com/store/apps/details?id=app.lightHome"
    const val URL_OLAUNCHER_PRO = "https://play.google.com/store/apps/details?id=app.prlightHome"
    ...
    const val URL_DIGITAL_WELLBEING_LEARN_MORE = "https://tanujnotes.substack.com/p/digital-wellbeing-app-on-android?utm_source=lightHome"
