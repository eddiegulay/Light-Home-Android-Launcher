...
import app.lightHome.data.AppModel
import app.lightHome.data.Constants
import app.lightHome.data.Prefs
import app.lightHome.databinding.FragmentHomeBinding
import app.lightHome.helper.expandNotificationDrawer
import app.lightHome.helper.getChangedAppTheme
import app.lightHome.helper.getUserHandleFromString
import app.lightHome.helper.isPackageInstalled
import app.lightHome.helper.openAlarmApp
import app.lightHome.helper.openCalendar
import app.lightHome.helper.openCameraApp
import app.lightHome.helper.openDialerApp
import app.lightHome.helper.openSearch
import app.lightHome.helper.setPlainWallpaperByTheme
import app.lightHome.helper.showToast
import app.lightHome.listener.OnSwipeTouchListener
import app.lightHome.listener.ViewSwipeTouchListener
...
class HomeFragment : Fragment(), View.OnClickListener, View.OnLongClickListener {
    ...
    private fun initObservers() {
        ...
        viewModel.isLightHomeDefault.observe(viewLifecycleOwner, Observer {
            if (it != true) {
