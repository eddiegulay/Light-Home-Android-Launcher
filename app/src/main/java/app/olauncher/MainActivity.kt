...
import app.lightHome.databinding.ActivityMainBinding
import app.lightHome.helper.*
import java.util.*
        ...
        when (prefs.userState) {
            ...
            Constants.UserState.REVIEW -> {
                if (prefs.rateClicked)
                    prefs.userState = Constants.UserState.SHARE
                else if (isLightHomeDefault(this))
            ...
            Constants.UserState.SHARE -> {
                if (isLightHomeDefault(this) && prefs.firstOpenTime.hasBeenDays(14)
